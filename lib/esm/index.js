...
export class AggregatorAccount {
    ...
    static getLeaseAddress(aggregatorAddress, queueAddress) {
        return generateResourceAccountAddress(HexString.ensure(aggregatorAddress), bcsAddressToBytes(HexString.ensure(queueAddress)));
    }
    async leaseAddress() {
...
export class LeaseAccount {
    ...
    static async init(client, account, params, switchboardAddress) {
        var _a, _b;
        let leaseAddr = generateResourceAccountAddress(HexString.ensure(params.aggregatorAddress), bcsAddressToBytes(HexString.ensure(params.queueAddress)));
