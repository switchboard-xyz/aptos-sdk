...
export class Aggregator {
    ...
    async loadData() {
        return (await this.client.getAccountResource(HexString.ensure(this.address).hex(), {
            address: HexString.ensure(this.devnetAddress).hex(),
            module: "Aggregator",
            name: "Aggregator",
            generic_type_params: [],
    ...
    async watch(callback) {
        const event = new AptosEvent(this.client, HexString.ensure(`${this.devnetAddress}::Switchboard::State`), {
            address: HexString.ensure(this.devnetAddress).hex(),
            module: "Switchboard",
            name: "State",
            generic_type_params: [],
