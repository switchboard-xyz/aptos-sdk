...
exports.generateResourceAccountAddress = exports.bcsAddressToBytes = exports.createFeed = exports.Permission = exports.OracleWallet = exports.LeaseAccount = exports.OracleQueueAccount = exports.OracleAccount = exports.CrankAccount = exports.JobAccount = exports.AggregatorAccount = exports.StateAccount = exports.AptosEvent = exports.sendRawAptosTx = exports.sendAptosTx = exports.SwitchboardPermission = exports.AptosDecimal = exports.SWITCHBOARD_STATE_ADDRESS = exports.SWITCHBOARD_DEVNET_ADDRESS = exports.OracleJob = void 0;
...
class AggregatorAccount {
    ...
    async loadJobs() {
        ...
        const jobs = data.job_keys.map((key) => new JobAccount(this.client, aptos_1.HexString.ensure(key).hex(), aptos_1.HexString.ensure(this.devnetAddress).hex()));
        const promises = [];
        for (let job of jobs) {
    ...
    async saveResult(account, params) {
        ...
        return sendRawAptosTx(this.client, account, `${this.devnetAddress}::aggregator_save_result_action::run`, [
            ...
            aptos_1.BCS.bcsSerializeU128(params.valueNum),
            aptos_1.BCS.bcsSerializeU8(params.valueScaleFactor),
            aptos_1.BCS.bcsSerializeBool(params.valueNeg),
            aptos_1.BCS.bcsSerializeBytes(aptos_1.HexString.ensure(params.jobsChecksum).toUint8Array()),
            aptos_1.BCS.bcsSerializeU128(params.minResponseNum),
            aptos_1.BCS.bcsSerializeU8(params.minResponseScaleFactor),
            aptos_1.BCS.bcsSerializeBool(params.minResponseNeg),
            aptos_1.BCS.bcsSerializeU128(params.maxResponseNum),
            aptos_1.BCS.bcsSerializeU8(params.maxResponseScaleFactor),
            aptos_1.BCS.bcsSerializeBool(params.maxResponseNeg),
        ], [
...
class JobAccount {
    ...
    async loadData() {
        return (await this.client.getAccountResource(this.address, `${aptos_1.HexString.ensure(this.devnetAddress).hex()}::job::Job`)).data;
    }
    async loadJob() {
        const data = await this.loadData();
...
class OracleQueueAccount {
    ...
    async loadData() {
        return (await this.client.getAccountResource(aptos_1.HexString.ensure(this.address).hex(), `${this.devnetAddress}::oracle_queue::OracleQueueAccount<${this.coinType}>`)).data;
    }
}
...
async function createFeed(client, account, params, devnetAddress) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
