...
async function createFeed(client, account, devnetAddress, aggregatorParams, jobInitParams, initialLoadAmount, crank) {
    ...
    let jobs = jobInitParams.length < 8
        ...
        : jobInitParams;
    const tx = await sendAptosTx(client, account, `${devnetAddress}::create_feed_action::run`, [
    ...
    return [
        new Aggregator(client, account.address(), devnetAddress, (_j = aggregatorParams.coinType) !== null && _j !== void 0 ? _j : "0x1::aptos_coin::AptosCoin"),
        tx,
    ];
}
