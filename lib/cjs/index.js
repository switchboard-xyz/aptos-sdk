...
class AggregatorAccount {
    ...
    static async init(client, account, params, switchboardAddress) {
        ...
        return [
            new AggregatorAccount(client, account.address(), switchboardAddress, (_l = params.coinType) !== null && _l !== void 0 ? _l : "0x1::aptos_coin::AptosCoin"),
            tx,
        ];
    }
    ...
    setConfigTx(accountAddress, params) {
...
class OracleQueueAccount {
    ...
    static async init(client, account, params, switchboardAddress) {
        ...
        return [
            new OracleQueueAccount(client, address, switchboardAddress, (_b = params.coinType) !== null && _b !== void 0 ? _b : "0x1::aptos_coin::AptosCoin"),
            tx,
        ];
    }
    async loadData() {
