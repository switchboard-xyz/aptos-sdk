...
exports.SWITCHBOARD_DEVNET_ADDRESS = `0x${"2B3C332C6C95D3B717FDF3644A7633E8EFA7B1451193891A504A6A292EDC0039".toLowerCase()}`;
// Address of the account that owns the Switchboard resource
exports.SWITCHBOARD_STATE_ADDRESS = `0x${"2B3C332C6C95D3B717FDF3644A7633E8EFA7B1451193891A504A6A292EDC0039".toLowerCase()}`;
class AptosDecimal {
...
async function sendAptosTx(client, signer, method, args, retryCount = 2) {
    ...
    if (simulation.vm_status === "Out of gas") {
        if (retryCount > 0) {
            const faucetClient = new aptos_1.FaucetClient(client.nodeUrl, "https://faucet.devnet.aptoslabs.com");
...
class State {
    constructor(client, address, account, devnetAddress = exports.SWITCHBOARD_DEVNET_ADDRESS) {
        this.client = client;
        this.address = address;
        this.account = account;
        this.devnetAddress = devnetAddress;
    }
    static async init(client, account, devnetAddress = exports.SWITCHBOARD_DEVNET_ADDRESS) {
...
exports.State = State;
class Aggregator {
    constructor(client, address, account, devnetAddress = exports.SWITCHBOARD_DEVNET_ADDRESS, stateAddress = exports.SWITCHBOARD_STATE_ADDRESS) {
        this.client = client;
        this.address = address;
        this.account = account;
        this.devnetAddress = devnetAddress;
     ...
     */
    static async init(client, account, params, devnetAddress = exports.SWITCHBOARD_DEVNET_ADDRESS, stateAddress = exports.SWITCHBOARD_STATE_ADDRESS) {
...
class Job {
    constructor(client, address, devnetAddress = exports.SWITCHBOARD_DEVNET_ADDRESS, stateAddress = exports.SWITCHBOARD_STATE_ADDRESS) {
        this.client = client;
        this.address = address;
        this.devnetAddress = devnetAddress;
        this.stateAddress = stateAddress;
